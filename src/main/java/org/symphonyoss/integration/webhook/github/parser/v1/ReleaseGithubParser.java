 ...
 */
@Component
public class ReleaseGithubParser extends BaseGithubParser {
  ...
  protected String getMessage(Map<String, String> parameters, JsonNode node)
    ...
    try {
      ...
      throw new GithubParserException(
          "Something went wrong while building the message for Github release event.", e);
    }
  }

  private String buildEntityML(JsonNode node) throws IOException, EntityXMLGeneratorException,
      URISyntaxException {
