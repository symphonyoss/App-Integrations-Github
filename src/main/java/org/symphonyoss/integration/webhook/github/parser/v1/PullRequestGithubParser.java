...
public class PullRequestGithubParser extends BaseGithubParser {
  ...
  protected String getMessage(Map<String, String> parameters, JsonNode node)
    ...
    try {
      ...
      throw new GithubParserException(
          "Something went wrong while building the message for Github pull_request event.", e);
    }
  }
  ...
  /**
   * Retrieves an specific label for the Pull Request action. If no label was defined returns the
   * action name.
