...
const Instructions = () => (
  <div>
    ...
    <h4>Step 2</h4>
    <p>
      In your Github account, select the repository you&rsquo;d like to receive notifications
      from. Choose Settings in the right navigation.
    </p>
    <figure>
    ...
    <p>
      Choose the events you&rsquo;d like to be notified of. Currently, the following are supported:
      code pushes, pull requests, comments on pull requests, issues, comments on issues, merges,
      and the latest deployment status.
    </p>
